...
mod 'puppet-jenkins', '3.2.1' # Do we need this, it is out of date and requires java < 5.0.0, and zypprepo
mod 'puppet-logrotate', '6.0.0'
mod 'puppet-nginx', '2.0.0'
mod 'puppet-php', '8.2.0' # Requires zypprepo
mod 'puppet-python', '6.4.0'
mod 'puppet-rabbitmq', '12.1.0'
